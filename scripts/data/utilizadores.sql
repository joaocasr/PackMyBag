...
VALUES
(2, 'Gonçalo Vale', 'gv', 'gv@mail.com', 'gvpass', '', 4, 'Male', 'Estilista incrivel e habilidoso');
(3, 'Orlando Belo', 'ob', 'ob@mail.com', 'obpass', '', 3, 'Male', 'Estilista com muita experiencia no ramo');
