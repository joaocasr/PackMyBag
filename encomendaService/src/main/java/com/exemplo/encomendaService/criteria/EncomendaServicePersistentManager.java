...
public class EncomendaServicePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "EncomendaService";
	...
	private EncomendaServicePersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(main.java.com.exemplo.encomendaService.model.Encomenda.class);
		aMetadataSources.addAnnotatedClass(main.java.com.exemplo.encomendaService.model.Cliente.class);
		aMetadataSources.addAnnotatedClass(main.java.com.exemplo.encomendaService.model.Loja.class);
		aMetadataSources.addAnnotatedClass(main.java.com.exemplo.encomendaService.model.Item.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new EncomendaServicePersistentManager();
		}
