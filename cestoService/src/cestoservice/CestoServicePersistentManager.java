...
public class CestoServicePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "CestoService";
	...
	private CestoServicePersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(cestoservice.Item.class);
		aMetadataSources.addAnnotatedClass(cestoservice.Peca.class);
		aMetadataSources.addAnnotatedClass(cestoservice.Cesto.class);
		aMetadataSources.addAnnotatedClass(cestoservice.Cliente.class);
		aMetadataSources.addAnnotatedClass(cestoservice.Set.class);
		aMetadataSources.addAnnotatedClass(cestoservice.Pagamento.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new CestoServicePersistentManager();
		}
